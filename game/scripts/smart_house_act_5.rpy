label smart_house_act_5_intro:
    ...
    if concernForZombies == True:
        ash "You've got a lot of explaining to do, Miss Neering."
        ash "For starters...{p=0.5} did you know that this house isn't even zombie-proof?"
        neering "What on earth are you talking about?"
        ash "The heartbeat monitor! It completely fails to account for instances of the walking dead!"
        ash "Vampires either, come to think of it."
        ash "What kind of ramshackle operation are you running here where any old undead creature can just waltz in and{nw}"
        warren "Please ignore them. Now..."
