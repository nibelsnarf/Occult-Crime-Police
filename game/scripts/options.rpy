...
init -1 python hide:
    ...
    config.name = "Occult Crime Police"
    config.version = "1.0"

    #This turns off Rollback
    config.rollback_enabled = False

    #This fixes the stuttering
    config.image_cache_size_mb = 750
    ...
    #style.window.background = "assets/gui/textboxtest.png"#Frame("assets/menu/BorderedWindow.png", 170,170)
    ...
    #style.window.yminimum = 327
    #style.window.xminimum = 1440
    ...
    style.button.activate_sound = "sound/sfx-pichoop.wav"
...
python early:
    config.save_directory = "Adventure Game Layout-1414361978"
