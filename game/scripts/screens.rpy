...
screen main_menu():
    ...
    frame:
        ...
        textbutton _("Credits") action Start("mm_credits")  text_style "mm_text"
...
screen custom_quit():
    vbox:
        ...
        ypos 540
        spacing 100
        text "Do you really want to quit? Unsaved progress may be lost." size 40 color "#000000" font "NeoBulletin Semi Bold.ttf"
        hbox:
            textbutton _("Quit to Menu") action [Hide("custom_menu"), Call("endgame")] xalign 0.5 text_size 50 background Frame("assets/menu/MenuBW.png",75) xsize 600 hover_ysize 70 text_hover_kerning 1
            textbutton _("Quit to Desktop") action Quit(confirm=False) xalign 0.5 text_size 50 background Frame("assets/menu/MenuBW.png",75) xsize 600 hover_ysize 70 text_hover_kerning 1
